...
public class LinuxSecretServiceProvider implements MasterKeyProvider {
    ...
    private final SecretToolResolver secretToolResolver;

    public LinuxSecretServiceProvider() {
        this(CommandRunner::run, LinuxSecretServiceProvider::findSecretToolCommand);
    }

    LinuxSecretServiceProvider(CommandExecutor commandExecutor, SecretToolResolver secretToolResolver) {
        this.commandExecutor = commandExecutor;
        this.secretToolResolver = secretToolResolver;
    }
    ...
    private static String findSecretToolCommand() {
    ...
    public boolean isAvailable() {
        ...
        try {
            ...
            CommandRunner.CommandResult result = commandExecutor.run(List.of(secretTool, "--version"), null);
    ...
    public byte[] getOrCreateMasterKey(SecureMetadata metadata, Component parent, boolean allowCreate)
        ...
        try {
            ...
            CommandRunner.CommandResult store = commandExecutor.run(List.of(secretTool, "store",
    ...
    private String resolveSecretToolCommand() {
        return secretToolResolver.resolve();
    }
